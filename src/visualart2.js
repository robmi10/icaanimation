...
function Visualart2() {
  ...
  return (
    <div className="screenlayout">
            ...
            <div className="block-appear" id = "second" style ={{zIndex:1, position:"absolute", top: 363, left:440}}>
                ...
                <h1 className="swingh1" style={{color: 'white'}}> {curr_visual_data["promotion_unit"]} </h1>
                <h3 className="swingh2" style={{color: 'white'}}> {curr_visual_data["promotion_sub_unit"]} </h3> 
                <p className="swingh3" style={{color: 'white'}}> /{curr_visual_data["article_unit_of_measurement"]} </p>
                </span>
            </div>

            <div className="block-appear"  style ={{position:"absolute", top: 158, left:435}}>
                <span><img alt="" style ={{zIndex:2, marginTop: -20, width: 210, height: 250}} src={blabar}></img> </span>
            </div>
